    ...
    <div class="main-card overflow-auto">
        ...
        @else
            ...
            <div class="flex justify-between gap-4 my-4">
                <div class="bg-linear-to-b from-slate-200 to-slate-50 border border-slate-300 rounded-xl w-full p-4 text-center text-xl">
                    Total<br><strong class="text-3xl">{{ $queue->total_tickets }}</strong>
                </div>
                <div class="bg-linear-to-b from-slate-200 to-slate-50 border-1 border-slate-300 rounded-xl w-full p-4 text-center text-xl">
